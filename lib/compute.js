...
exports.computeAll = function (obj, s, runOnce) {
  for (var key in s) {
    ...
    if (Object.keys(obj).indexOf(key) > -1) args.push(obj[key]);
    ...
    if (canCompute) obj[key] = _generate.call( obj, gen, runOnce );
  }
...
exports.computeValue = function (skm, opts, val) {
  ...
  return exports.canCompute.apply(null, arguments)
    ? _generate.call( null, skm.generate, opts.once )
    : val;
...
function _generate(gen, runOnce) {
