...
function AuxArray( values, castAs, forceAsObject ) {
  ...
  arr._schema = typeof castAs !== 'string' ? castAs : undefined;
...
AuxArray.prototype._convertToSchema = function( value ) {
  if (this._schema) return this._schema.toRecord( value );
  else return value;
};
...
AuxArray.prototype.push = function() {
  var values = [].map.call( arguments, this._convertToSchema, this );
...
AuxArray.prototype.set = function( index, value ) {
  this[ index ] = this._convertToSchema( value );
